@php
    // Cargar saludos y tomar hasta 8 aleatorios (o menos si no hay)
    ...
    shuffle($cartas);
@endphp
<head><title>Saludos: Test</title></head>
@include('partials.navbar')
<main class="memorama-app" id="memoramaApp">
    <div class="container">
        <header class="mem-header">
            <div class="title-block">
                <h1 class="mem-title">Memorama — Saludos en LESSA</h1>
            ...
            <div class="mem-controls" role="region" aria-label="Controles del juego">
                ...
                <form class="mem-buttons" method="POST" action="{{ route('lecciones.saludos.complete') }}">
                    @csrf
...
<script>
    (function () {
        ...
        function revealAll(duration = 1000) {
            if (lock) return;
