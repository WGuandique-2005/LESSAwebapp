...
<head>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            ...
            .videos-container { grid-template-columns: 1fr; gap: 16px; padding: 10px 1vw 30px 1vw; }
...
<body>
    ...
    <section class="hero-section">
        ...
        <p>
            Explora nuestra colección de videos educativos del canal <b>LESSA Virtual</b>.<br>
            Aprende el Lenguaje de Señas Salvadoreño de forma visual y práctica, con explicaciones claras y ejemplos reales.<br>
