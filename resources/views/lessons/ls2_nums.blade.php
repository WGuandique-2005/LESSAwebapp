...
<head>
    ...
    <title>Números - LESSA (Lección 2)</title>
    <link
    ...
    <div class="lesson-layout">
        <nav class="sidebar" role="navigation" aria-label="Menú de lección">
            ...
            <ul id="sidebarMenu" aria-hidden="false">
                ...
                <li data-section="abc" role="button" tabindex="0">Números en LESSA</li>
                <li data-section="letras" role="button" tabindex="0">Explorando Cada Número</li>
        ...
        <div class="main-content" id="mainContent">
            ...
            <section id="intro">
                <div class="section-title">Introducción — Lección 2: Números</div>
                <div class="section-desc">
                    Bienvenido a la segunda lección de LESSA, enfocada en los números. En esta lección aprenderás las
                    señas para representar cantidades, formar números compuestos (como 11, 20, 100, 1000) y cómo combinar
                    decimales y unidades según la convención de LESSA. Practica los movimientos y secuencias para mejorar tu
                    fluidez al comunicar cantidades.
                </div>
                <span class="badge">¡Cuenta Iniciada!</span>
            </section>

            <section id="abc">
                <div class="section-title">Los Números en LESSA</div>
                <div class="section-desc">
                    En LESSA los números se representan mediante configuraciones manuales y combinaciones secuenciales.
                    Algunos números tienen señas propias (20, 30, 100) y otros se forman combinando un decimal seguido
                    de la unidad (por ejemplo, 11 = 10 + 1). Aprende la base (10), las reglas de combinación y cómo
                    ejecutar los movimientos correctamente para que tus señas sean claras y entendibles.
                </div>
                <span class="badge">¡Número Maestro!</span>
            </section>

            <section id="letras">
                <div class="section-title">Explorando Cada Número</div>
                <div class="section-desc">
                    Aquí encontrarás la representación visual y la descripción detallada de cada número en LESSA. Observa
                    las imágenes, sigue la explicación de la configuración de mano y la dinámica (movimientos/giros) y
                    practica las secuencias para números compuestos. La repetición y la precisión del movimiento son clave.
                </div>
                <div class="include-carrusel">
                    @include('carrusel.numeros')
                </div>
                <span class="badge">¡Visión Numérica!</span>
            </section>

            <section id="practica">
                <div class="section-title">Practica y Gana Insignias</div>
                <div class="section-desc">
                    ¡Es hora de poner a prueba tus habilidades con números! En esta sección encontrarás ejercicios
                    interactivos para reforzar el reconocimiento y la producción de las señas numéricas. Completa los retos
