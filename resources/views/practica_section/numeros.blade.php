...
<head>
    ...
    <style>
        ...
        :root {
            /* Paleta de Colores - TEMA MORADO (NÚMEROS) */
        ...
        * {
        ...
        .lesson-card:hover {
            ...
            border-color: rgba(107, 77, 255, 0.1);
        }
...
<body>
    ...
    <main>
        ...
        <section class="hero-section">
            <div class="container hero-content">
                <h1 class="hero-title">Nivel 2: Cifras y Conteo</h1>
                <h2 class="hero-subtitle">¡Domina la numeración en LESSA, desde el 0 hasta el 1,000!</h2>
                <p class="hero-desc">
                    La capacidad de contar y comunicar cantidades es crucial. Estos mini-juegos te desafiarán a
                    reconocer, producir y ordenar números grandes y pequeños.
                </p>
            </div>
        </section>
        ...
        <div class="container">
            @php
                ...
                $userId = Auth::id();
                $totalNiveles = 4;
                // Donde ID de la leccion comience con 'NUM'
            ...
            <section class="games-section">
                ...
                <div class="cards-grid">
                    <!-- Game 1 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/numeros/adivina'">
                    ...
                    <!-- Game 2 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/numeros/memorama'">
                    ...
                    <!-- Game 3 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/numeros/conecta'">
                        <div class="card-icon icon-game3">
                            <i class="fas fa-brain"></i>
                        </div>
                        <div class="card-content">
                            <h3>Conecta</h3>
                            <p>Conecta la imagen de la seña y el número correspondiente. Fortalece tu memoria visual.</p>
                        </div>
                        <div class="card-footer">
                            <span>Jugar Ahora</span>
                            <i class="fas fa-play card-arrow"></i>
                    ...
                    <!-- Game 4 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/numeros/extra'">
    ...
    <div id="result-modal" class="modal-overlay">
        <div class="modal-content" id="modal-content-area">
            ...
            <button class="modal-btn" onclick="window.location.href='{{ route('nivel.numeros') }}'">
