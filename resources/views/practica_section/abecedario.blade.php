...
<head>
    ...
    <style>
        ...
        /* Ajustes para que la imagen de fondo se aprecie mejor */
        .hero-bg-img {
            position: absolute;
            top: 0;
            left: 0;
            ...
            height: 100%;
            object-fit: cover;
            /* Se ha aumentado la opacidad para que la imagen se note */
            opacity: 0.4; 
            z-index: 0;
            filter: grayscale(10%) brightness(1.2); /* Sutil mejora de contraste */
        }
...
<body>
    ...
    <main>
        <section class="hero-section">
            <img src="{{ asset('img/aprender.png') }}" alt="Background image" class="hero-bg-img">
