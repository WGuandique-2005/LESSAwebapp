@php
    // Cargar datos de salud y tomar 6 aleatorios
        ...
        <div class="card compact-card">
            <div class="card-body">
                ...
                <form id="completeForm" class="actions-row" method="POST"
                    action="{{ route('lecciones.salud.conecta.complete') }}">
                    @csrf
...
<script>
    (function () {
        ...
        // Enviar el formulario y redirigir al nivel salud
        btnContinue.addEventListener('click', function () {
            // Cambia la acción del formulario si es necesario
            completeForm.action = "{{ route('lecciones.salud.conecta.complete') }}";
            completeForm.submit();
        });
