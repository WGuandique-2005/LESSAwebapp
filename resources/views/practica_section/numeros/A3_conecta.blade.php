@php
    // Cargar datos de numeros y tomar 6 aleatorios
        ...
        <div class="card compact-card">
            <div class="card-body">
                ...
                <form id="completeForm" class="actions-row" method="POST"
                    action="{{ route('lecciones.numeros.conecta.complete') }}">
                    @csrf
...
<script>
    (function () {
        ...
        btnContinue.addEventListener('click', function () {
            completeForm.action = "{{ route('lecciones.numeros.conecta.complete') }}";
            completeForm.submit();
        });
