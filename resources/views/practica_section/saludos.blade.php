...
<head>
    ...
    <style>
        ...
        :root {
            /* Paleta de Colores - TEMA VERDE (SALUDOS) */
...
<body>
    ...
    <main>
        ...
        <section class="hero-section">
            <div class="container hero-content">
                <h1 class="hero-title">Nivel 3: El Contexto Social</h1>
                <h2 class="hero-subtitle">¡Aprende a presentarte y a usar las frases de cortesía en LESSA! 👋</h2>
                <p class="hero-desc">
                    Dominar los saludos y las expresiones sociales es el primer paso para una interacción real. Estos
                    mini-juegos te enseñarán a responder, a iniciar conversaciones y a mostrar respeto.
                </p>
            </div>
        </section>
        ...
        <div class="container">
            ...
            <section class="games-section">
                ...
                <div class="cards-grid">
                    <!-- Game 1 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/saludos/adivina'">
                        <div class="card-icon icon-game1">
                            <i class="fas fa-comments"></i>
                        </div>
                        <div class="card-content">
                            <h3>Adivina el Saludo</h3>
                            <p>Identifica el Saludo correcto entre múltiples opciones. ¡Rapidez y precisión!</p>
                        </div>
                    ...
                    <!-- Game 2 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/saludos/memorama'">
                    ...
                    <!-- Game 3 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/saludos/conecta'">
                        <div class="card-icon icon-game3">
                            <i class="fas fa-hands-helping"></i>
                        </div>
                        <div class="card-content">
                            <h3>Conecta</h3>
                            <p>Conecta la imagen de la seña y el saludo que se muestra. Fortalece tu memoria visual.</p>
                        </div>
                        <div class="card-footer">
                            <span>Jugar Ahora</span>
                            <i class="fas fa-play card-arrow"></i>
                    ...
                    <!-- Game 4 -->
                    <div class="lesson-card" onclick="window.location.href='/practicar/saludos/extra'">
                        <div class="card-icon icon-game4">
                            <i class="fas fa-user-friends"></i>
                        </div>
                        <div class="card-content">
                            <h3>Práctica de Presentación</h3>
                            <p>Completa una simulación de vídeo o texto haciendo las señas para presentarte.</p>
                        </div>
                        <div class="card-footer">
                            <span>Jugar Ahora</span>
                            <i class="fas fa-play card-arrow"></i>
    ...
    <div id="result-modal" class="modal-overlay">
        <div class="modal-content" id="modal-content-area">
            ...
            <button class="modal-btn" onclick="window.location.href='{{ route('nivel.saludos') }}'">
